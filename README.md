# MoPanning
MoPanning is a perception-based real-time visualization program for stereo audio including music. Below are instructions on how to install and use it. If you prefer video instructions, or just want a demo of what MoPanning can do, check out our video on [YouTube](https://youtu.be/Z8oFoO5eTAc)! After you have tried it out, we would love your feedback, and you can reach us at mopanning@outlook.com.
...
## Using MoPanning
In order to generate a visualization, you will first need to set up your settings. To open the settings panel, press '⌘ ,' ('ctrl ,' on Windows) or select 'MoPanning > Settings...'. 

### Audio Devices
The first and most important settings are your input and output devices. Your output device should be set to your headphones, speakers, or audio interface, and your input device should be set to whatever device you would like to receive your audio from (if in Streaming mode).
...
### Other Settings
The other settings MoPanning offers change aspects of the analysis algorithms and the visualization. We encourage you to tinker with the settings to find what looks the best to you. On Mac, you can also use the record button in the top right to record MoPanning's output.
